...
# ---------------------------------------------------------
    ...
    2. **SMOTE**: Oversamples the minority class (Churn = Yes) inside the pipeline, so resampling never leaks into validation folds.
    3. **Classifier**: `XGBClassifier` tuned via `RandomizedSearchCV` (best params: `n_estimators=200`, `max_depth=5`, `learning_rate=0.05`).
    """)
